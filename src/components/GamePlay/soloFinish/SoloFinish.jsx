...
export default function SoloFinish({ seconds, minutes, numberOfMove }) {
  ...
  return (
    <div className="soloFinishBigBox">
      <div className="soloFinish">
        ...
        <span className="fontFamily gameOverSoloText">
        ...
        <button className="fontFamily soloSetup marginAdd15">
          Setup New Game
        </button>
      </div>
    </div>
