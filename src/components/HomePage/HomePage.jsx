        ...
        <div className="main">
         ...
         <div className="box">
            <div className="first">
                ...
                <StarterPageButton description={"Numbers"} backgroundColor={selectedTheme === "Numbers" ? "#304859" : "#BCCED9"} setChosenButton={setSelectedTheme} key={1}/>
                <StarterPageButton description={"Icons"} backgroundColor={selectedTheme === "Icons" ? "#304859" : "#BCCED9"} setChosenButton={setSelectedTheme} key={2} />
                </div>
            ...
            <div className="third">
                ...
                <StarterPageButton description={"4x4"} backgroundColor={selectedGridSize === "4x4" ? "#304859" : "#BCCED9"} setChosenButton={setSelectedGridSize} key={7}/>
                <StarterPageButton description={"6x6"} backgroundColor={selectedGridSize === "6x6" ? "#304859" : "#BCCED9"} setChosenButton={setSelectedGridSize} key={8}/>
                </div>
            </div>
